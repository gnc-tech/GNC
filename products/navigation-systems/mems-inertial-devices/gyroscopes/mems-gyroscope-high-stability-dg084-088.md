...
![Product Image](https://www.gnc-tech.com/images/products/D-Q-JDW-DG084-088-Slide-01.webp)

![Product Image](https://www.gnc-tech.com/images/products/D-Q-JDW-DG084-088-Slide-02.webp)
...
```json
{
        headers: ['Performance', 'JDWDG084', 'Unit'],
        rows: [
...
```json
{
        headers: ['Performance', 'JDWDG085', 'Unit'],
        rows: [
...
```json
{
        headers: ['Performance', 'JDWDG086', 'Unit'],
        rows: [
...
```json
{
        headers: ['Performance', 'JDWDG087', 'Unit'],
        rows: [
...
```json
{
        headers: ['Performance', 'JDWDG088', 'Unit'],
        rows: [
...
*This document is automatically generated from source file `navigation\mems\gyroscope\D-Q-JDW-DG084-088.mdx` *
